...
df.fr3$ratio.centered	 <- 0.01*((df.fr3$ratio.corrected2 - mean(df.fr3$ratio.corrected2)) /
	sd(df.fr3$ratio.corrected2));
df.fr3$coverage.centered <- 0.01*((df.fr3$coverage.corrected2 - mean(df.fr3$coverage.corrected2)) /
	sd(df.fr3$coverage.corrected2));
df.fr3$combined.centered <- 0.01*((df.fr3$combined2 - mean(df.fr3$combined2)) / sd(df.fr3$combined2));
