...
write.table(
	mt_matrix,
	file.path(outdir, paste0(id, "_mito_stats.txt")),
	sep = "\t"
	);

rm(mt_median, mt_mean, dens, mt_mode, mt_lower_quartile, mt_upper_quartile, mt_short,
	mt_long, mt_ratio, mt_coverage, mt_fraction, mt_nFrag, mt_width, mt_matrix);
