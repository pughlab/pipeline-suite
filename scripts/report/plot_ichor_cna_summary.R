...
parser$add_argument('-c', '--cnas', type = 'character', help = 'path to gene by sample matrix of cna calls (generated by collect_ichorCNA_output.R)');
parser$add_argument('-m', '--metrics', type = 'character', help = 'path to ploidy and cellularity estimates (generated by collect_ichorCNA_output.R)');
...
# write for latex
write("\\section{SCNA Summary}", file = 'cna_summary_ichor.tex');
write("Copy number calls from ichorCNA:", file = 'cna_summary_ichor.tex', append = TRUE);

# CNA landscape plot
write("\\begin{figure}[h!]", file = 'cna_summary_ichor.tex', append = TRUE);
write("\\begin{center}", file = 'cna_summary_ichor.tex', append = TRUE);
write(paste0(
	"\\includegraphics[width=0.9\\textwidth]{",
	getwd(), '/',
	generate.filename(arguments$project, 'ichorCNA_landscape','png'), '}'
	), file = 'cna_summary_ichor.tex', append = TRUE);
write("\\end{center}", file = 'cna_summary_ichor.tex', append = TRUE);
write(paste0(
	"\\caption{", cna.caption, "}"
	), file = 'cna_summary_ichor.tex', append = TRUE);
write("\\end{figure}\n", file = 'cna_summary_ichor.tex', append = TRUE);
...
if ((nrow(ploidy.estimates) <= 20)) {
	write("\n\\begin{figure}[h!]", file = 'cna_summary_ichor.tex', append = TRUE);
	write("\\begin{center}", file = 'cna_summary_ichor.tex', append = TRUE);
	write(paste0(
