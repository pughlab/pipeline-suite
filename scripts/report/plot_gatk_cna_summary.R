...
write("\\section{SCNA Summary}", file = 'cna_gatk_summary.tex');
write("Copy number variation was also called using GATK (v4.1.8.1) using GATK's best practices guidelines:", file = 'cna_gatk_summary.tex', append = TRUE);

write("\\begin{figure}[h!]", file = 'cna_gatk_summary.tex', append = TRUE);
write("\\begin{center}", file = 'cna_gatk_summary.tex', append = TRUE);
write(paste0(
	"\\includegraphics[width=0.9\\textwidth]{",
	getwd(), '/',
	generate.filename(arguments$project, 'gatk_scna_landscape','png'), '}'
	), file = 'cna_gatk_summary.tex', append = TRUE);
write("\\end{center}", file = 'cna_gatk_summary.tex', append = TRUE);
write(paste0(
	"\\caption{", cna.caption, "}"
	), file = 'cna_gatk_summary.tex', append = TRUE);
write("\\end{figure}\n", file = 'cna_gatk_summary.tex', append = TRUE);
