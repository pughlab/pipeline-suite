...
#	col.lines = chr.breaks,
	...
	resolution = 400,
	right.padding = 15,
	filename = generate.filename(arguments$project, 'panel_cna_landscape','png')
	);
...
write("\\section{SCNA Summary}", file = 'cna_summary_mops.tex');
write("Copy number variation was called using PanelCN.mops (v1.14.0) for all target regions:", file = 'cna_summary_mops.tex', append = TRUE);

write("\\begin{figure}[h!]", file = 'cna_summary_mops.tex', append = TRUE);
write("\\begin{center}", file = 'cna_summary_mops.tex', append = TRUE);
write(paste0(
	"\\includegraphics[width=0.9\\textwidth]{",
	getwd(), '/',
	generate.filename(arguments$project, 'panel_cna_landscape','png'), '}'
	), file = 'cna_summary_mops.tex', append = TRUE);
write("\\end{center}", file = 'cna_summary_mops.tex', append = TRUE);
write(paste0(
	"\\caption{", cna.caption, "}"
	), file = 'cna_summary_mops.tex', append = TRUE);
write("\\end{figure}\n", file = 'cna_summary_mops.tex', append = TRUE);
